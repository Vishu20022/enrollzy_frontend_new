                        ...
                        <tbody>
                            @foreach($pages as $page)
                                <tr>
                                    ...
                                    <td><a href="{{ route('pages.dynamic', $page->slug) }}" target="_blank" class="text-decoration-none text-primary"><i class="fas fa-external-link-alt me-1 small"></i> /page/{{ $page->slug }}</a></td>
