                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control" name="content" id="editor">{{ old('content', $page->content) }}</textarea>
                                @error('content')
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" name="meta_title" value="{{ old('meta_title', $page->meta_title) }}" placeholder="Optimized title...">
                            </div>
                            
                            <div class="mb-3">
                                <label for="meta_keywords" class="form-label text-muted small fw-bold">Meta Keywords</label>
                                <textarea class="form-control form-control-sm" name="meta_keywords" rows="2" placeholder="Keyword 1, Keyword 2...">{{ old('meta_keywords', $page->meta_keywords) }}</textarea>
                            </div>
                            
                            <div class="mb-0">
                                <label for="meta_description" class="form-label text-muted small fw-bold">Meta Description</label>
                                <textarea class="form-control form-control-sm" name="meta_description" rows="3" placeholder="Brief description for search engines...">{{ old('meta_description', $page->meta_description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
