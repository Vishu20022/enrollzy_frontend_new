...
<!-- HERO SECTION -->
<section class="about-hero-section position-relative overflow-hidden py-5" style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%);">
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6 position-relative fade-in-up delay-1 text-center mt-lg-0 mt-5">
                <div class="hero-image-wrapper position-relative d-inline-block" style="max-width: 100%; width: 480px;">
                    ...
                    <div class="position-absolute rounded-circle" style="width: 250px; height: 250px; top: -40px; right: -40px; z-index: -1; filter: blur(50px); background-color: rgba(22, 60, 151, 0.12) !important;"></div>
                    <div class="position-absolute rounded-circle" style="width: 200px; height: 200px; bottom: -40px; left: -40px; z-index: -1; filter: blur(50px); background-color: rgba(255, 193, 7, 0.12) !important;"></div>
                    
                    <!-- Floating Stats Badge 1 -->
                    <div class="position-absolute bg-white p-3 rounded-3 shadow-lg d-flex align-items-center gap-3 fade-in-up delay-2 text-start" style="top: 10%; left: -30px; border-left: 4px solid #163c97; z-index: 2; min-width: 220px;">
                        <div class="rounded-2 p-2 d-flex align-items-center justify-content-center" style="width: 38px; height: 38px; background-color: #e6f0fa; color: #163c97;">
                            <i class="fas fa-graduation-cap fs-5"></i>
                        </div>
                        <div>
                            <h6 class="fw-bold mb-0 text-dark" style="font-size: 0.85rem; font-family: 'Outfit', sans-serif;">Education Partners</h6>
                            <small class="text-muted" style="font-size: 0.7rem;">1,200+ Colleges</small>
                        </div>
                    </div>
                    
                    <!-- Floating Stats Badge 2 -->
                    <div class="position-absolute bg-white p-3 rounded-3 shadow-lg d-flex align-items-center gap-3 fade-in-up delay-3 text-start" style="bottom: 10%; right: -20px; border-left: 4px solid #ffc107; z-index: 2; min-width: 220px;">
                        <div class="rounded-2 p-2 d-flex align-items-center justify-content-center" style="width: 38px; height: 38px; background-color: #fff9e6; color: #ffc107;">
                            <i class="fas fa-user-check fs-5"></i>
                        </div>
                        <div>
                            <h6 class="fw-bold mb-0 text-dark" style="font-size: 0.85rem; font-family: 'Outfit', sans-serif;">Trusted Guidance</h6>
                            <small class="text-muted" style="font-size: 0.7rem;">100k+ Students</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center mt-4 fade-in-up delay-3">
            <div class="col-lg-8 text-center">
                <div class="bg-light p-3 rounded-4 position-relative border border-white shadow-sm">
                    <div class="text-dark fst-italic mb-0" style="line-height: 1.6; font-size: 0.95rem;">{!! $page->founders_common_message !!}</div>
                </div>
            </div>
        </div>
        @endif
